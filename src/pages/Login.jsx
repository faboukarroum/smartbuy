          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-vintage-200">
            <div className="p-8 md:p-12">
              <div className="text-center mb-10">
                ...
                <p className="text-vintage-500">Sign in to your {BRAND_NAME} account</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button disabled className="flex items-center justify-center gap-2 py-3 px-4 border border-vintage-200 rounded-xl opacity-60 cursor-not-allowed">
                  ...
                  <span className="text-sm font-medium text-vintage-700">Google coming soon</span>
                </button>
              </div>
            </div>
